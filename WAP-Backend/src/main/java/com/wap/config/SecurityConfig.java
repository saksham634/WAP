...
public class SecurityConfig {
    ...
    // New Bean to handle Cross-Origin Resource Sharing globally
    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        CorsConfiguration configuration = new CorsConfiguration();
        configuration.setAllowedOrigins(Arrays.asList("*")); // Allows requests from any origin (e.g., Live Server)
