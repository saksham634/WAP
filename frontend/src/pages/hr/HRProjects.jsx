...
export default function HRProjects() {
  ...
  useEffect(() => {
    async function loadProjectsData() {
      ...
      try {
        ...
        // Safe to ignore if user permissions vary
      }
    }
    loadProjectsData();
  }, []);
  ...
  return (
    <div className="page-content" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      <Header
        title="Projects & Resourcing"
        subtitle="Inspect cross-functional deliverables, team distributions, and active project timelines"
      />
      ...
      {loading ? (
        ...
        <p style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>No projects recorded.</p>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  >
                    <i className="fa-solid fa-users-viewfinder"></i> View Assigned Team ({proj.assignedUsers ? proj.assignedUsers.length : 0})
                  </button>
                </div>
              </div>
            );
